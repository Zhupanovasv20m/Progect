...
Для того, чтобы переместиться с одной ветки на другую в темнгимале необходимо ввести команду: *git checkout <название ветки>*.

### Просмотр списка веток
Для просмотра списка веток в терминале необходимо ввести команду *git branch*.
